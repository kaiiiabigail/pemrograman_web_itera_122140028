...
export const renderTasks = (tasks) => {
    ...
    if (tasks.length === 0) {
        tasksList.innerHTML = '<p class="empty-message">Tidak Ada Tugas, Masukkan Tugas Terlebih Dahulu!</p>';
        return;
    }
    ...
    sortedTasks.forEach(task => {
        ...
        taskElement.innerHTML = `
            ...
            <div class="task-details">
                <span class="task-deadline ${dueSoonClass}">Due: ${formatDate(task.deadline)}</span>
...
export const renderSchedule = (scheduleItems) => {
    ...
    if (scheduleItems.length === 0) {
        scheduleList.innerHTML = '<p class="empty-message">Tidak Ada Jadwal Kelas, Masukkan Jadwal Kelas Terlebih Dahulu!</p>';
        return;
    }
    ...
    dayOrder.forEach(day => {
        ...
        dayItems.forEach(classItem => {
            ...
            const timeDisplay = new Date(`2000-01-01T${classItem.time}`).toLocaleTimeString('id-ID', {
                hour: '2-digit',
                minute: '2-digit',
                hour12: false
            });
...
export const renderNotes = (notes) => {
    ...
    if (notes.length === 0) {
        notesList.innerHTML = '<p class="empty-message">Tidak Ada Catatan, Masukkan Catatan Terlebih Dahulu!</p>';
        return;
    }
